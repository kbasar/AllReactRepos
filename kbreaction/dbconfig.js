  ...
  objectStoresMeta: [
    {
      ...
      storeSchema: [
        ...
        {
          name: "sliding_window",
          keypath: "sliding_window",
          options: { unique: false }
        },
        {
          name: "casement_window",
          keypath: "casement_window",
          options: { unique: false }
        },
        {
          name: "fixed_window",
          keypath: "fixed_window",
          options: { unique: false }
        },
        {
          name: "ventilation_window",
          keypath: "ventilation_window",
          options: { unique: false }
        },
        {
          name: "glass_mess",
